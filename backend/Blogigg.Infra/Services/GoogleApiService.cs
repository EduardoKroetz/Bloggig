...
public class GoogleApiService : IGoogleApiService
{
    ...
    public async Task<string> ExchangeOAuthCodeForTokenAsync(string code)
    {
        ...
        var clientId = _configuration["GoogleClientId"] ?? throw new Exception("Invalid google client id");
        var clientSecret = _configuration["GoogleClientSecret"] ?? throw new Exception("Invalid google client secret");
